...
datablock AudioProfile(BloodDripSound1) {
	fileName = $DS::Path @ "res/sounds/physics/blood_drip1.wav";
	description = AudioSilent3D;
	preload = true;
};
datablock AudioProfile(BloodDripSound2) {
	fileName = $DS::Path @ "res/sounds/physics/blood_drip2.wav";
	description = AudioSilent3D;
	preload = true;
};
datablock AudioProfile(BloodDripSound3) {
	fileName = $DS::Path @ "res/sounds/physics/blood_drip3.wav";
	description = AudioSilent3D;
	preload = true;
};
datablock AudioProfile(BloodDripSound4) {
	fileName = $DS::Path @ "res/sounds/physics/blood_drip4.wav";
	description = AudioSilent3D;
	preload = true;
};
...
{
	shapeFile = $DS::Path @ "res/shapes/decals/footprint.dts";
};

datablock StaticShapeData(pegprintDecal)
{
	shapeFile = $DS::Path @ "res/shapes/decals/pegprint.dts";
};

datablock staticShapeData(BloodDecal1) {
	shapeFile = $DS::Path @ "res/shapes/decals/blood1.dts";
...
datablock staticShapeData(BloodDecal2) {
	shapeFile = $DS::Path @ "res/shapes/decals/blood2.dts";
